...
These examples demonstrate syntax that the parser cannot recover from.
...
All examples in this directory produce a "Parse failed" error:
...
For examples of syntax that the parser can recover from, see `../syntax_recovery/`.
