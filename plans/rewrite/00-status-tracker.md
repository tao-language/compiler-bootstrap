...
> **Last updated:** 2026-04-28 (Updated: 2026-04-28 - Phase 2d-2e complete (numeric types, TypRef, FFI calls). Phase 3.1 complete ($type definition parsing). 696 tests passing, 19 failures.)
...
| 2026-04-28 | **Phase 2d-2e complete:** Numeric type support ($I8–$I64, $U8–$U64, $F16–$F64) via LiteralType and TypRef term variant. TypRef parsing for $Int/$Float and all numeric types. FFI call syntax with typed args and return type. Type definition parsing: $type { | #C(args) -> ReturnType }. All 696 tests passing, 19 failures. |
