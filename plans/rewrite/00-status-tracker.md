...
**Code metrics:** 16 source files (exhaustiveness.gleam updated, infer.gleam updated, syntax.gleam updated with De Bruijn index shifting and parse_type_def_body_with_body fix, eval.gleam updated with do_app state extension and match_state outer vars), 942 tests passing, 2 failures remaining.
