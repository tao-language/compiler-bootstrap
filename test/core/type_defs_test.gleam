...
pub fn find_constructor_exists_test() {
  let constructors = make_constructors(["Some", "None"], v_neut(0), t_var(0))
...
pub fn find_constructor_bool_test() {
  let constructors = make_constructors(["True", "False"], v_neut(0), t_var(0))
...
pub fn find_constructor_empty_test() {
  let constructors = make_constructors([], v_neut(0), t_var(0))
...
pub fn subst_hvar_zero_test() {
  let template = Var(0, single("test", 0, 0))
