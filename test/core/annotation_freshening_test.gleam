// ============================================================================
// ANNOTATION FRESHENING TESTS
// ============================================================================
/// Tests for the `freshen_annotation` function which replaces negative
/// hole IDs with fresh positive IDs before type-checking.
///
/// This is the fix for the InfiniteType bug: by giving each annotation
/// type unique hole IDs, we prevent unification cycles caused by shared
/// negative hole IDs.
import gleeunit
import gleeunit/should
import core/ast.{Hole, Pi, Lam, Ctr, Unit, Var, App, Rcd}
